...
MIDDLEWARE = [
    ...
    'blog.middleware.IpSecurityMiddleware',
...
elif env_bool('DJANGO_USE_SQLITE', False):
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.sqlite3',
...
XION_READ_TIMEOUT = float(os.getenv('XION_READ_TIMEOUT', '1800'))
XION_MAX_RETRIES = int(os.getenv('XION_MAX_RETRIES', '2'))
BLOG_FILE_MAX_UPLOAD_BYTES = int(os.getenv('BLOG_FILE_MAX_UPLOAD_BYTES', str(1024 * 1024 * 1024)))

...
class UploadFile(models.Model):
    ...
    poster_url = models.CharField(max_length=500, blank=True, default='', help_text="视频封面URL")
    poster_storage_backend = models.CharField(max_length=16, blank=True, default='', help_text="封面存储后端")
    poster_storage_key = models.CharField(max_length=500, blank=True, default='', help_text="封面存储标识")
